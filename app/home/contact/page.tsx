  ...
  return (
    <Container>
      <div className="grid lg:grid-cols-2">
        <Card className="z-10 flex flex-col justify-between border-none bg-muted shadow-2xl">
          <CardHeader>
          ...
          <CardContent className="grid gap-5">
            <section className="flex gap-2">
              ...
              <section className="flex flex-col">
                <a
                  target="_blank"
                  className="text-justify hover:text-primary"
                  href="https://maps.google.com/?q=29.478706374677504,52.54372870296799"
                >
                  شیراز، شهرک صنعتی بزرگ شیراز، بلوار صنعت جنوبی، خیابان 101،
                  فرعی 103
                </a>
                <a
        ...
        <Card className="-mt-4 border-none lg:-mr-4 lg:mt-0">
          <a
            target="_blank"
            href="https://maps.google.com/?q=29.478706374677504,52.54372870296799"
          >
